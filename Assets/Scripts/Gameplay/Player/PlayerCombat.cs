...
public class PlayerCombat : MonoBehaviour
{
    ...
    public void DealDamage()
    {
        ...
        Collider2D[] enemis = Physics2D.OverlapCircleAll(
            ...
            StatsService.Instance.Stats.WeaponRange,
            enemyMask);
        ...
        foreach (Collider2D enemy in enemis)
        {
            ...
            damageable.TakeDamage(StatsService.Instance.Stats.Damage, transform);
        }
    ...
    //    Gizmos.DrawWireSphere(attackPoint.position, StatsService.Instance.Stats.WeaponRange);
    //}
}
